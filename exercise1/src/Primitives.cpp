...
void CreateCube(HEMesh& mesh)
{
	...
	// generate vertices
	HEMesh::VertexHandle vhandles[8];
	
	vhandles[0] = mesh.add_vertex(HEMesh::Point(-0.5f, -0.5f, 0.5f));
	vhandles[1] = mesh.add_vertex(HEMesh::Point(0.5f, -0.5f, 0.5f));
	vhandles[2] = mesh.add_vertex(HEMesh::Point(0.5f, 0.5f, 0.5f));
	vhandles[3] = mesh.add_vertex(HEMesh::Point(-0.5f, 0.5f, 0.5f));
	vhandles[4] = mesh.add_vertex(HEMesh::Point(-0.5f, -0.5f, -0.5f));
	vhandles[5] = mesh.add_vertex(HEMesh::Point(0.5f, -0.5f, -0.5f));
	vhandles[6] = mesh.add_vertex(HEMesh::Point(0.5f, 0.5f, -0.5f));
	vhandles[7] = mesh.add_vertex(HEMesh::Point(-0.5f, 0.5f, -0.5f));
